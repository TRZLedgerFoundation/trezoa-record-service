...
pub struct TransferTokenizedRecord {
    ...
    pub new_token_account: trezoa_program::pubkey::Pubkey,
    ...
    pub class: Option<trezoa_program::pubkey::Pubkey>,
}
...
pub struct TransferTokenizedRecordBuilder {
    ...
    new_token_account: Option<trezoa_program::pubkey::Pubkey>,
...
impl TransferTokenizedRecordBuilder {
    ...
    pub fn new_token_account(
        &mut self,
        new_token_account: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    /// Class account of the record
    #[inline(always)]
    pub fn class(&mut self, class: Option<trezoa_program::pubkey::Pubkey>) -> &mut Self {
        self.class = class;
        self
    }
...
pub struct TransferTokenizedRecordCpiAccounts<'a, 'b> {
    ...
    /// New Token Account for the tokenized record
    pub new_token_account: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Record account associated with the tokenized record
    pub record: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Token2022 Program used to freeze/unfreeze the tokenized record
    pub token2022: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Class account of the record
    pub class: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
}
...
impl<'a, 'b> TransferTokenizedRecordCpiBuilder<'a, 'b> {
    ...
    pub fn new_token_account(
        &mut self,
        new_token_account: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct TransferTokenizedRecordCpiBuilderInstruction<'a, 'b> {
    ...
    new_token_account: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
